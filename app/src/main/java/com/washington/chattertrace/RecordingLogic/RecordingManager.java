...
public class RecordingManager extends Service {
    public static final String RECORDER_BROADCAST_ACTION = "com.washington.chattertrace.Recording.ACTION";
    ...
    public boolean isRecording(){
        ...
        if (recorder != null) {
            System.out.println("BASIC RECORDER EXISTS");
    ...
    public void onCreate() {
        super.onCreate();
        System.out.println("BASIC RECORDER START");
